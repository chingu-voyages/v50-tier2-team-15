...
const HomeScreen = () => {
  ...
  return (
       <div className="bg-gradient-to-b from-white to-[#bb9f85]">
      <section className="flex items-center justify-between py-10">
        <div className="w-1/4">
          <img src={heroImage} alt="Hero" />
        </div>
        <div className="w-3/4 pr-4">
          <h1 className="text-5xl font-bold text-center text-purple-900 mt-4">
            FlavorFinder
          </h1>
          <p className="text-xl text-center text-orange-600 mt-2">
...
//   return (
//     <div className="absolute inset-0 z-0 bg-gradient-to-b from-white to-[#bb9f85]">
//       <Navbar />
//       <section className="flex items-center justify-between py-10">
//         <div className="w-1/4">
